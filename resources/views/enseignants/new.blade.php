...
@section('contenu')
    <div class="row">
        <div class="col-8">
            <div class="card my-4">
                <div class="card-title bg-primary">
                    <h4 style="font-style: italic " class="mx-2 my-3 text-light">Ajout Des Enseignants</h4>
                </div>
                <hr>
                <div class="card-body">
                    <form action="{{ route('adds.enseignant') }}" method="POST">
                        @csrf
                        <div class="form-row" style="margin: 10px;">
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control my-2" name="regime">
                                    <option value="">......</option>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control my-2 @error('email') is-invalid @enderror"
                                    name="email">
                            ...
                            <div class="col-6">
                                <label for="">Photo enseignant</label>
                                <input type="file"
        ...
        <div class="col-4">
            <div class="card my-4">
                <div class="card-title bg-primary">
                    <h4 class="text-light mx-2 my-3" style="font-style: italic">Photo de l'enseignant</h4>
                </div>
                <div class="card-body">
